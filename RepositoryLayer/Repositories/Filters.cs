...
namespace RepositoryLayer.Repositories
{
    public class Filters
    {
        public DataTable GetFilteredProducts(List<FilterCriteria> filters, int subcategoryId)
        {
            ...
            using (SqlConnection connection = new SqlConnection("Data source=DESKTOP-4DH234D\\SQLEXPRESS;initial catalog=master;persist security info=True;user id=sa;password=000;Connect Timeout=30;MultipleActiveResultSets=true"))
            {
