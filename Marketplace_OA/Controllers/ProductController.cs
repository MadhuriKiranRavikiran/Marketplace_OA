...
namespace Marketplace_OA.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult ProductCompare(string ids)
        {
            ...
            var productDetails = new List<List<ProductAttributeDetailVM>>();
            foreach (var productId in productIds)
            {
                var detailsDTO = _productsService.GetProductById(productId);
                var detailsVM = mapper.Map<List<ProductAttributeDetailVM>>(detailsDTO);
                productDetails.Add(detailsVM);
            }
